...
const TEST_METADATA = {
    ...
    '16': { title: 'Есет пен Жаңқожа', subject: 'Қазақстан тарихы' },
    '17': { title: '1867-1868 Жылдардағы реформа', subject: 'Қазақстан тарихы' },
    '15': { title: '10-сынып Қазақстан тарихы тест 1', subject: 'Қазақстан тарихы' },
    '16': { title: 'XIX ғасырдағы 50 жылдар', subject: 'Қазақстан тарихы' },
    '17': { title: 'XIX ғасырдағы 67-68 жылдар', subject: 'Қазақстан тарихы' },
